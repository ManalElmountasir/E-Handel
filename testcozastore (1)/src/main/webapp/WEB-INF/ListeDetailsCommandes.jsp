...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
 ...
 <sql:setDataSource
    ...
    />
     ...
     <sql:query var="ProdCde" dataSource="${myDS}">
       SELECT * FROM ecom.procde WHERE numcde = ? ;
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Gestion des <b> details de la commande </b></h2>
					</div>
					<div class="col-sm-6">
            ...
            <table class="table table-striped table-hover" id="thetable">
                ...
                <c:forEach var="ProdCde" items="${ProdCde.rows}">
                    ...
                    <tr>
						...
						<td>
						<c:out value="${ProdCde.numCde}" />
						</td>
						<td>
						<c:out value="${ProdCde.numPro}" />
						</td>
						<td>
						<c:out value="${ProdCde.nomPro}" />
						</td>
						<td>
						<c:out value="${ProdCde.qte}" />
						</td>
...
<!--    <td><a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a></td>
 --> 
  <td>  <a href="ListeDetailsCommandes?action=delete&id=<c:out value="${ProdCde.numPro}" />">Delete</a></td>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form name="addProdCde" action="/testcozastore/ListeCommandes" method="POST"  enctype="multipart/form-data">
					<div class="modal-header">						
						<h4 class="modal-title">Ajouter produit dans la commande</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">					
						<div class="form-group">
						<input type="hidden" name="action" value="addProdCde">
						...
						<div class="form-group">
							<label>Num produit</label>
							<input type="text" name="numPro" class="form-control" >
						</div>
						<div class="form-group">
							...
							<select name="famPro" class="form-select" aria-label="Default select example">
                                      ...
                                      <option value="<c:out value="${row.nomPro}" />"><c:out value="${row.nomPro}" /></option>
                                     </c:forEach> 
				...
				<form action="/testcozastore/Listecommandes"  method="POST" enctype="multipart/form-data">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="hidden" id="numCde" name="numCde"class="form-control" >
						</div>
						<div class="form-group">
...
$(document).ready(function(){
	...
	$('#thetable').find('tr').click( function(){
		...
		var numPro=($('td', this).eq(2).text().replace(/\s/g, ''));
		var nomPro=($('td', this).eq(3).text().replace(/\s/g, ''));
		var qte=($('td', this).eq(4).text().replace(/\s/g, ''));
		 $("#numCde").val(numCde);
		 $("#numPro").val(nomCli);
		 $("#nomPro").val(adrCli);
		 $("#qte").val(dateCde);
